...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode animCurveTA -n "SDK2FKBigToe1_R_rotateZ";
...
createNode animCurveTA -n "SDK1FKBigToe2_R_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK2FKLongToe1_R_rotateZ";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
...
createNode animCurveTA -n "SDK1FKLongToe2_R_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKLongToe3_R_rotateZ";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "longCurl" -ln "longCurl" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK2FKMiddleToe1_R_rotateZ";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
...
createNode animCurveTA -n "SDK1FKRingToe2_R_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKRingToe3_R_rotateZ1";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "ringCurl" -ln "ringCurl" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "SDK1FKPinkyToe3_R_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKMiddleToe1_R_rotateY";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKLongToe1_R_rotateY";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "spread" -ln "spread" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKBigToe1_R_rotateY";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "spread" -ln "spread" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "SDK1FKPinkyToe1_R_rotateY";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK2FKBigToe1_L_rotateZ";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "bigCurl" -ln "bigCurl" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "SDK1FKBigToe2_L_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK2FKLongToe1_L_rotateZ";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "longCurl" -ln "longCurl" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "SDK1FKLongToe2_L_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKLongToe3_L_rotateZ";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "longCurl" -ln "longCurl" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK2FKMiddleToe1_L_rotateZ";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "middleCurl" -ln "middleCurl" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "SDK1FKRingToe2_L_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKRingToe3_L_rotateZ1";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "ringCurl" -ln "ringCurl" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "SDK1FKPinkyToe3_L_rotateZ";
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKMiddleToe1_L_rotateY";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "spread" -ln "spread" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKLongToe1_L_rotateY";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "spread" -ln "spread" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	...
	setAttr ".pre" 4;
	setAttr ".pst" 4;
createNode animCurveTA -n "SDK1FKBigToe1_L_rotateY";
	addAttr -ci true -sn "drivingSystemOut" -ln "drivingSystemOut" -at "message";
	addAttr -ci true -sn "spread" -ln "spread" -smn -2 -smx 10 -at "float";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
